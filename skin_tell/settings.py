"""
Django settings for skin_tell project.
...
SECRET_KEY = 'django-insecure-ba&vrj(2p^i+5z$*)^4_wglr+z@2v_ofzqh(l==n#8%warxb1j'
...
MIDDLEWARE = [
    ...
    # Other middleware AccountMiddleware...
...
ROOT_URLCONF = 'skin_tell.urls'


#Configure authentication backends and URLs
...
WSGI_APPLICATION = 'skin_tell.wsgi.application'
